...
class Mask(QtWidgets.QWidget):
  def __init__(self, imgWidth, imgHeight, infile, imagefile, sleepTime):
    ...
    #self.outfile = outfile          # Sensor Readings Output File
...
def main():
  ...
  mask = Mask(args.width, args.height, args.mask, args.image, args.sleepTime)
